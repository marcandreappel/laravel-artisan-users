...
class ArtisanUsersServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        if ($this->app->runningInConsole()) {
            $this->publishes([__DIR__.'/../config/artisan-users.php' => config_path('artisan-users.php')], 'config');
        }
    }
    ...
    {
        $this->mergeConfigFrom(__DIR__.'/../config/artisan-users.php', 'artisan-users');
